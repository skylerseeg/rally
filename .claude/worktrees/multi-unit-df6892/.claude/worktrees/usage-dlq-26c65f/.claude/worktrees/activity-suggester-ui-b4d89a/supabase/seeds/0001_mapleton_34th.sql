-- supabase/seeds/0001_mapleton_34th.sql
-- Reusable seed for the hosted project. Run by hand via the Supabase
-- SQL Editor (the harness blocks anything that targets the linked
-- project from this machine).
--
-- Mirrors supabase/seed.sql, which is applied automatically by
-- `supabase db reset` locally. Keep them in sync — if you change one,
-- change the other.
--
